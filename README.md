...
the middleware can be seen as a means of validating requests to a server route before response is generated, it helps to simplify
operations on an end point and also reduces repetition in your code

- [x] Describe a Resource?
A resource is an object with a type, associated data, relationships to other resources, and a set of methods that operate on it

- [x] What can the API return to help clients know if a request was successful?
A positive response code like 200, 201...
